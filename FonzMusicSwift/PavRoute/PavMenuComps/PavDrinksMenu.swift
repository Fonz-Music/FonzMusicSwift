...
struct PavDrinksMenu: View {
    ...
    var body: some View {
        VStack {
            ...
            case .wine:
                PavWineMenu(wineList: drinksMenu.wine)
                
            case .cocktails:
                PavCocktailMenu(cocktailList: drinksMenu.cocktails)
                
            case .soda:
                PavSodaMenu(sodaList: drinksMenu.soda)
                
            case .hotDrinks:
                PavHotDrinkMenu(hotDrinkList: drinksMenu.hotDrinks)
            }
        }
    }
}
