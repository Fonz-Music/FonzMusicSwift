...
struct LaunchSpotifyWebview: UIViewRepresentable {

    
    
    
    func makeCoordinator() -> LaunchSpotifyWebview.SpotifyWebViewWk {
        return SpotifyWebViewWk()
    }
...
//    var controller: UIViewController
    ...
    func makeUIView(context: UIViewRepresentableContext<LaunchSpotifyWebview>) -> UIButton {
...
//        webby.openURL(userToken: "sdsfsddsbsafdsf")
        ...
        context.coordinator.openURL(userToken: "asdasdsad")
